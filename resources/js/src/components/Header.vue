                ...
                <div v-if="isUserMenuOpened" class="header__user__menu">
                    ...
                    <button @click="logout">
                        ...
                        >
                            ...
                            <g mask="url(#b)">
                                <path fill="#1451EE" d="M0 .5h24v23.578H0z" />
                            </g>
                            <defs>
                                <pattern
                                    id="a"
...
.header__user__menu > button {
    display: flex;
    gap: 2rem;
}

.header__user__menu > button:hover {
    color: var(--color-btn-hover);
}

.header__user__menu > button:hover g path {
    fill: var(--color-btn-hover);
}

.header__user__menu > button:active {
    color: var(--color-btn-active);
}

.header__user__menu > button:active g path {
